...
@XmlRootElement(name = "SetSavedGameDescription")
public class SetSavedGameDescription {

    protected Integer savedGameId;
    @XmlElementRef(name = "description", namespace = "http://addonservice.curse.com/", type = JAXBElement.class, required = false)
