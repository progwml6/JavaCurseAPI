...
@XmlRootElement(name = "SetSavedGameName")
public class SetSavedGameName {

    protected Integer savedGameId;
    @XmlElementRef(name = "name", namespace = "http://addonservice.curse.com/", type = JAXBElement.class, required = false)
