...
@XmlRootElement(name = "v2GetFingerprintMatches")
public class V2GetFingerprintMatches {

    @XmlElementRef(name = "fingerprints", namespace = "http://addonservice.curse.com/", type = JAXBElement.class, required = false)
