...
@XmlRootElement(name = "v2GetAddOns")
public class V2GetAddOns {

    @XmlElementRef(name = "ids", namespace = "http://addonservice.curse.com/", type = JAXBElement.class, required = false)
